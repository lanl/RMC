...
"""
Example of DDS for 2D Normal Distribution
=========================================

This script demonstrates the usage of a Denoising Diffusion Sampler
(DDS) for sampling from a skewed 2D Normal distribution.
"""
...
"""
Set distribution: simple lopised 2D Normal distribution.
"""
...
"""
Construct Denoising Diffusion Sampler (DDS) Model. It uses a Flax neural network (NN) model,
...
# Save plot
save_plot(fig, nn_conf["root_path"] + "sampleDDS_s2D.png")
