...
"""
Example of PIS for 2D Normal Distribution
=========================================

This script demonstrates the usage of a Path Integral Sampler
(PIS) for sampling from a skewed 2D Normal distribution.
"""
...
# Save plot
save_plot(fig, nn_conf["root_path"] + "samplePIS_s2D.png")
